...
const Features = () => {
  return (
    <>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="rgb(30 58 138)" fill-opacity="1" d="M0,0L48,5.3C96,11,192,21,288,48C384,75,480,117,576,117.3C672,117,768,75,864,85.3C960,96,1056,160,1152,192C1248,224,1344,224,1392,224L1440,224L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path></svg>
    ...
    <img src="src/assets/CollaborativeSpirit_Icon (1).svg" alt="" className='gap-5 h-20 w-20 bg-green-500 rounded-full '/>
      ...
      We empower our experts in each discipline, market, and region of the world to act on their insights and encourage active sharing and debate of ideas between team members across the globe
        ...
        <div  >
      <h3 class="text-1xl w-1/2 
       mb-2 font-bold ">Who We Are</h3>
      <p class="w-96  ">
