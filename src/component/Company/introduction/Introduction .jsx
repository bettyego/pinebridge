...
const Introduction = () => {
  return (
    <div className="introduction h-screen bg-blue-900 w-full flex flex-col md:flex-row p-4 md:p-8">
      {/* Left section */}
      <div className="p-4 w-full md:w-1/2 text-white flex justify-center flex-col" data-aos="fade-up">
        <h2 className="text-2xl md:text-3xl font-bold mb-2">Our Capabilities</h2>
      ...
      {/* Right section */}
      <div className="flex flex-col w-full md:w-1/2 text-black items-center mt-8 md:mt-0">
        {/* Multi-Asset */}
        <div className="w-full md:w-2/3 flex gap-x-8 md:gap-x-16 p-4" data-aos="fade-up">
        ...
        {/* Fixed Income */}
        <div className="p-4 flex gap-x-8 md:gap-x-12 w-full md:w-2/3" data-aos="fade-up">
