...
const Features = () => {
  return (
    <>
      ...
      <div className='min-h-screen text-black flex justify-around items-center w-full p-4 md:p-8 '>
        <div className='flex flex-col gap-8 w-full  md:gap-x-12 '>
          {/* Feature 1 */}
          <div className="flex flex-col md:flex-row gap-4 p-4 md:p-8 items-center md:items-start w-full">
        ...
        {/* "Who We Are" Section */}
        <div className="mt-8 md:mt-12  pl-24">
