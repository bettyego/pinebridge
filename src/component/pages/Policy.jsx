...
const Policy = () => {
  return (
    ...
    <div className="max-w-7xl mx-auto p-12 bg-white rounded-lg shadow-md">
      ...
      <section className="mb-8 leading-relaxed ">
        <p className=''>PineBridge recognizes the importance of protecting your non-public information when you visit https://www.pinebridge.com/ or its regional websites (individually and collectively, the “Website”). This Privacy Policy (“Policy“) applies to the collection, use, disclosure and protection of personal data, relating to customers of PineBridge Investments LLC and its subsidiaries and related entities (collectively, “PineBridge”) through its Website. By visiting the Website, you are accepting the practices described in this Policy. If you do not agree to this Policy, please refrain from using the Website. Additionally, certain terms and conditions applicable to your use of the Website can be found under the Website Terms of Use link. Regional disclosures that may apply per jurisdiction can be found under the privacy policy link on the PineBridge website designed for that region.</p>

        <p className='pt-4'>“Personal Data” means information pertaining to specific individuals, or by which specific individuals can be identified, including by name, identification number, address, or other personal characteristics or attributes. Personal Data does not include aggregated statistics, compilations, anonymous data, or other derivative data that does not, alone or with other data, identify a specific individual.</p>

        <p className='pt-8'>“Data Subject” means an individual who is the subject of personal data.</p>
      </section>
      <section className=" mb-8 leading-relaxed  ">
        <h2 className="text-2xl font-bold mb-2">Changes to this Policy</h2>
        <p className=''>PineBridge reserves the right to change, modify, add or remove portions of this Policy at any time and for any reason. Such changes will become effective upon posting. We suggest that you review this policy periodically for changes. You will be able to determine when this Policy has been revised by checking the Last Revised legend at the top of this Policy. You acknowledge that by accessing our Website after changes have been posted to this Policy, you are agreeing to the terms of the Policy as modified.</p>
      </section>
      <section className="mb-8  leading-relaxed">
        <h2 className="text-2xl font-bold mb-2">Basic Principle</h2>
        <p className=" ">
      ...
      <section className="mb-8  leading-relaxed">
        ...
        <ul className='mb-8  leading-relaxed'>
            <li className='pt-4'>Request that we amend, rectify, delete or update the personal data we hold about you;</li>
            <li className='pt-4'>Where possible (e.g., in relation to marketing) amend or update your choices around processing; and</li>
            <li className='pt-4'>Request a copy of personal data held by us.</li>
        </ul>
        <p className=" ">
      ...
      <section className="mb-8 leading-relaxed">
        <h2 className="text-2xl font-bold mb-2">Disclosure to Third Parties</h2>
        <p className="pt-4 ">
        ...
        <p className='pt-4'>PineBridge may disclose aggregate data about its Website and its visitors, provided however that PineBridge will not disclose to third parties any information that could be used to identify you personally.</p>
      </section>
      <section className="mb-8 leading-relaxed">
        <h2 className="text-2xl font-bold mb-2">Security of Your Personal Information</h2>
        <p className=" ">
  ...
  <section className="mb-8 leading-relaxed">
    <h2 className="text-2xl font-bold mb-2">Compliance with Laws</h2>
    <p className=" ">
  ...
  <section className="mb-8 leading-relaxed">
    <h2 className="text-2xl font-bold mb-2">Business Transfers</h2>
    <p className=" ">
  ...
  <section className="mb-8 leading-relaxed">
    ...
    <p className="">
      Consistent with the Children's Online Privacy Protection Act of 1998, we will never knowingly request or collect personally identifiable information from anyone under 13 without prior verifiable parental consent.
    </p>
  </section>
